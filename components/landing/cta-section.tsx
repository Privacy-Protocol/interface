      ...
      <div className="mx-auto max-w-6xl">
        <TerminalFrame contentClassName="p-8 sm:p-12" variant="accent">
          <div className="relative text-center">
            ...
            <p className="mx-auto mt-3 max-w-md text-base text-muted-foreground">
              Explore the docs, browse the code, and start integrating privacy
              into your app.
            </p>

            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Button asChild>
                <Link href={PAGE_LINKS.DOCS}>Read the docs</Link>
              </Button>

              <Button asChild variant="outline">
                <Link href={PAGE_LINKS.GITHUB}>View on GitHub</Link>
              </Button>
            </div>
          </div>
        </TerminalFrame>
